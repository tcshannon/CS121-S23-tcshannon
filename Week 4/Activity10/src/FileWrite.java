//********************************************************************
// Activity 10 part 2 of 3
// Name: Tyler Shannon
// Date: 2/13/23
//********************************************************************
// This program writes data to a text file. The file format is
...
// and write it to the file "courses.txt". The data must be entered
...
public class FileWrite {
    ...
    public static void main(String[] args) {
        ...
        try (BufferedWriter bw = new BufferedWriter(new FileWriter("courses.txt"))) {
            ...
            bw.write("Course Code\tCourse Name\tInstructor\tSchedule\tRoom\n");
            bw.flush();
